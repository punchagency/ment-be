...
"""
""" Django settings for ttscanner_backend project. Generated by 'django-admin startproject' using Django 5.2.8. """
...
# Optional: Frontend base URL for reference in code
